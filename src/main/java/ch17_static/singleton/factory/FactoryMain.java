...
public class FactoryMain {
    public static void main(String[] args) {
        ...
        // 현재 우리 코드의 소소한 문제점
        // SmartPhone smartPhone1 = new SmartPhone("임의의 공장", "임의의 스마트폰", "임시 넘버");
        // System.out.println(smartPhone1);
        // 공장을 통하지 않고 스마트폰 객체를 생성
        // 이상의 이유 : @AllArgsConstructor를 적용했는데 걔는 기본적으로 public임.
        // 그래서 @AllArgsConstructor(access = AccessLevel.PACKAGE)로 수정해주면 11번 라인이 오류 발생
