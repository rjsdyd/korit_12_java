...
public class Main {
    ...
    /*
        ...
        아닌지를 구분할 수 없기 때문에 이를 판단하는 메서드를 Main에서 정의하겠음.
     */
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            문제가 되지 않음. 그러면 animal field에 Tiger / Human / Car
            객체가 들어가있다는 점은 여기 main에서 확인 안됨. 코드 다른 곳을
            까봐야됨.
         */
        ...
        /*
            ...
            AnimalData 클래스를 확인해야 하는데, 저희가 (Animal)이라고 형변환을
            시키는 부분 때문임. Car를 Animal로 형변환시킬 수 있는 근거 없는 상태이기 때문임.\
         */
        ...
        if(animalData100 == null) System.out.println("내부에 값이 없습니다.");
        else System.out.println("객체는 있는데 필드에 값이 없습니다");
